...
@section('main-content')
    ...
    <section class="account-section registration-section bg_img" style="background-image: url(' {{ getImage('assets/images/frontend/signup_bg/' . 'taq.gif', '1920x1280') }}');">
        ...
        <div class="account-section-right">
            <div class="top text-center mb-5">
                <a href="{{ route('home') }}" class="account-logo">
                    <h3 style="color:#fff">Taqwa Sacco DRMS</h3>
                </a>
            </div>
            <div class="middle">
