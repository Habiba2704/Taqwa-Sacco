...
@section('content')
    ...
    @endphp
    <section class="hero bg_img" style="background-image: url('{{ getImage('assets/images/frontend/banner/' . 'taq.gif', '1920x1280') }}');">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9 text-center">
                    <h2 class="hero__title wow fadeInUp text-white" data-wow-duration="0.5s" data-wow-delay="0.3s">
                        Taqwa Sacco Default Risk Assessment System
                    </h2>
                    <p class="wow fadeInUp mt-4 text-white" data-wow-duration="0.5s" data-wow-delay="0.3s">
                        We provide you with the best loan services based on your risk score to ensure we have a long term relationship
                    </p>
